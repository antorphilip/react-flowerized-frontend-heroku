...
const AboutUs = () => {
  return (
    <>
      ...
      <div className="">
        <div
          className={`flex items-center justify-center ${styles.bgimage2}`}
        >
          <div className="w-[90%] lg:w-2/3 flex my-28 rounded-xl shadow-xl overflow-hidden">
            ...
            <div className="px-7 py-14 w-full text-center bg-white">
              ...
              <div className="mt-14 space-y-20">
                <p className="font-[Alata] text-[#694E4E] text-xl">The Blooms by Marra was started 8 years ago with their online
